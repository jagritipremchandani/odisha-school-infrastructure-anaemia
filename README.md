...
Aggregation: Both predictors and outcomes are measured at the district level. School-level variation in infrastructure is averaged out, and district-level anaemia prevalence aggregates across women with very different individual circumstances. Relationships that exist at the individual or school level may not be detectable in aggregate data.
